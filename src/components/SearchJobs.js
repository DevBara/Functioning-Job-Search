...
class SearchJobs extends React.Component{
    ...
    async getJobs(){
        ...
        try{
           let jobsInfo=await axios.get(`https://api.adzuna.com/v1/api/jobs/us/search/10?app_id=${appId}&app_key=${key}&results_per_page=${this.props.results_per_page}&what=${this.props.what}&title_only=${this.props.what}&where=${this.props.where}&distance=${this.props.distance}&content-type=application/json`)
